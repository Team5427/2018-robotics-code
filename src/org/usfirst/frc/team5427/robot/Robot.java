...
//		motor_pwm_rearLeft
		...
		encLeft = new Encoder(Config.ENCODER_LEFT_CHANNEL_A, Config.ENCODER_LEFT_CHANNEL_B, false,
...
//		Log.info("E");
	...
	public void autonomousInit() {
		...
		new PIDStraightMovement(this.speedcontrollergroup_right, this.speedcontrollergroup_left, .3, 88, .1, 0, .1).start();
//		new PIDTurn(speedcontrollergroup_left, speedcontrollergroup_right, 90).start();
