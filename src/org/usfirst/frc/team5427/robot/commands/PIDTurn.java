...
public class PIDTurn extends PIDCommand {
	...
	/**
	 * Creates a PID loop that turns a specified amount of degrees
	 * This constructor uses the PID turn values in config
	 * Sets the starting speed to 0.1 for the speed ramp-up
	 * 
	 * @param scgRight
	 * @param scgLeft
	 * @param setPoint
	 ...
	 * Sets the starting speed to 0.1 for the speed ramp-up
	 * 
	 * @param scgRight the speed controller group on the right side of the robot
	 * @param scgLeft the speed controller group on the left side of the robot
	 * @param setPoint the setpoint of the PID loop in degrees
	 * @param time the amount of time until the command times out
	 * @param p the p value to be used in the PID loop.
	 * @param i the i value to be used in the PID loop.
	 * @param d the d value to be used in the PID loop.
	 */
	 ...
	 * 
	 * @return true if the robot has been within the setpoint for at least half a second, if the timeout is reached, or if the encoder has stopped
	 */
	@Override
	public boolean isFinished() {
		...
		if(Robot.encLeft.getStopped()&&hasStarted) {
			return true;
		}
	 ...
	 * 
	 * @param output the output from the PID loop to be used in the motors
	 */
	@Override
