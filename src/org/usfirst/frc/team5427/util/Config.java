...
public class Config {
	...
	/******************** DIO PORTS *******************/
	/**
	 * The DIO port value for the A channel of the encoder on the left portion of the drive train.
	 */
	public static final int ENCODER_LEFT_CHANNEL_A=0;
	
	/**
	 * The DIO port value for the B channel of the encoder on the left portion of the drive train.
	 */
	...
	/**
	 * The DIO port value for the limit switch located at the bottom of the elevator.
	 */
	...
	/**
	 * The button that correlates to moving the elevator down manually without the limit switch affecting it.
	 */
	...
	/**
	 * The distance the robot needs to travel before the straight PID loop activates.
	 */
	...
	/**
	 * The right selection for choosing the starting position in the autonomous chooser.
	 */
	public static final int RIGHT = 1;
	
	/**
	 * The center selection for choosing the starting position in the autonomous chooser.
	 */
	public static final int CENTER = 2;
	
	/**
	 * The left selection for choosing the starting the position in the autonomous chooser.
	 */
	...
	/******************** MISCELLANEOUS *******************/
	/**
	 * The value used in PIDControllers to determine when to switch to using the PID loop.
	 */
