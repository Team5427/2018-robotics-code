...
/**
 * This command moves the robot forwards 18 inches.
 * Used in the Right_SwitchIsLeft command.
 * 
 * @author Akshat Jain
 */
public class Right_SwitchIsLeft_FirstDistance extends PIDCommand {
	 ...
	 *            command.
	 */
	public Right_SwitchIsLeft_FirstDistance(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
