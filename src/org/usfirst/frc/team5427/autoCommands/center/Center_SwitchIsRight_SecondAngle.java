 ...
 */
@SameLine
public class Center_SwitchIsRight_SecondAngle extends PIDCommand {
	/**
	 ...
	 */
	public Center_SwitchIsRight_SecondAngle(SpeedControllerGroup scgRight, SpeedControllerGroup scgLeft) {
