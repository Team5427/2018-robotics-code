...
/**
 * This is the class to navigate the robot from the switch (center switch is left) 
 * to move back from the switch and point to the second cube.
 * 
 * @author Akshat Jain
 */
@SameLine
public class Center_SwitchIsLeft_CurveToSwitch extends AutoPath {
	/**
	 ...
	 * determine how much the robot should curve during the  segment of its
	 ...
	 */
	public Center_SwitchIsLeft_CurveToSwitch() {
	...
	public boolean isFinished() {
		return (Math.abs(Math.abs(Robot.ahrs.getYaw())-45) < 3);
	}
