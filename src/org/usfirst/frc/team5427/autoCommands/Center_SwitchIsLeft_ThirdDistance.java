 ...
 * @author Akshat Jain
 */
public class Center_SwitchIsLeft_ThirdDistance extends PIDCommand {
	 ...
	 *            command.
	 */
	public Center_SwitchIsLeft_ThirdDistance(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
