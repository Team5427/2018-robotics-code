 ...
 */
@SameLine
public class Right_ScaleAndSwitch_FirstAngle extends PIDCommand {
	/**
	 ...
	 */
	public Right_ScaleAndSwitch_FirstAngle(SpeedControllerGroup scgRight, SpeedControllerGroup scgLeft) {
