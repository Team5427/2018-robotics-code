...
public class Left_SwitchIsLeft extends AutoPath {
	...
	/**
	 * The first distance of the path. It travels 154 inches forward at our short power.
	 */
	private PIDStraightMovement firstDistance;
	
	/**
	 * The second distance of the path. It travels 16 inches forward at our short power.
	 */
