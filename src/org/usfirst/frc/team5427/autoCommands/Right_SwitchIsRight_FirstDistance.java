...
/**
 * This command moves the robot forwards 154 inches.
 * Used in the Left_SwitchIsLeft command.
 * 
 * @author Akshat Jain
 */
public class Right_SwitchIsRight_FirstDistance extends PIDCommand {
	 ...
	 *            command.
	 */
	public Right_SwitchIsRight_FirstDistance(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
