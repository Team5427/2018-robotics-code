 ...
 * @author Akshat Jain
 */
public class TwoFeet extends PIDCommand {
	 ...
	 *            command.
	 */
	public TwoFeet(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
	...
	protected void usePIDOutput(double output) {
		...
		if (this.power < this.maximumSpeed && null == pidDistance) {
			this.power += (Config.PID_STRAIGHT_LINEAR_INCREMENT-.001)/2;
		}
