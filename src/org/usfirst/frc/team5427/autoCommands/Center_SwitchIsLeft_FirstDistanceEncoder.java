 ...
 * @author Andrew Li
 */
public class Center_SwitchIsLeft_FirstDistanceEncoder extends Command {
	/**
	 ...
	 */
	public Center_SwitchIsLeft_FirstDistanceEncoder(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
	...
	protected void execute() {
		Robot.driveTrain.drive_Left.set(.25);
		Robot.driveTrain.drive_Right.set(-.25);
	}
	...
	public boolean isFinished() {
		SmartDashboard.putNumber("encValueL", Robot.encLeft.getDistance());
		SmartDashboard.putNumber("dist", distance);
		return Math.abs(Robot.encLeft.getDistance()) >= distance;
	}
