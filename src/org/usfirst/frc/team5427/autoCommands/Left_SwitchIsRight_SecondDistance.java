...
/**
 * This command moves the robot forwards 171 inches.
 * Used in the Left_SwitchIsRight command.
 * 
 * @author Andrew Li
 */
public class Left_SwitchIsRight_SecondDistance extends PIDCommand {
	 ...
	 *            command.
	 */
	public Left_SwitchIsRight_SecondDistance(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
