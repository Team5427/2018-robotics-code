...
/**
 * This command moves the robot forwards 75 inches.
 * Used in the Left_SwitchIsRight command.
 * 
 * @author Andrew Li
 */
public class Left_SwitchIsRight_ThirdDistance extends PIDCommand {
	 ...
	 *            command.
	 */
	public Left_SwitchIsRight_ThirdDistance(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
