...
public class LeftScale_PickupCube extends AutoPath{
	/**
	 ...
	 */
	LeftScale_TurnToCube turnToCube;
	
	/**
	 * Drives forward into the cube's position.
	 */
	LeftScale_DriveToCube moveToCube;
	
	/**
	 * Drives backward away from the scale.
	 */
	LeftScale_DriveBackward backOff;
	...
	public LeftScale_PickupCube() {
		backOff = new LeftScale_DriveBackward();
//		resetElevator = new MoveElevatorAuto(3);
		turnToCube = new LeftScale_TurnToCube(Robot.driveTrain.drive_Right, Robot.driveTrain.drive_Left);
		moveToCube = new LeftScale_DriveToCube();
