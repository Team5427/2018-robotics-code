 ...
 * @author Andrew Li
 */
public class Left_ScaleIsRight_ThirdDistanceEncoder extends Command {
	/**
	 ...
	 */
	public Left_ScaleIsRight_ThirdDistanceEncoder(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
