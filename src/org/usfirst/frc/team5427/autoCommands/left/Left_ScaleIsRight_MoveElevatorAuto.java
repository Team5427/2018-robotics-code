 ...
 * @author Andrew Li
 */
public class Left_ScaleIsRight_MoveElevatorAuto extends Command {

	/**
	 * Sets the timeout for the command to the scale timeout in config
	 */
	public Left_ScaleIsRight_MoveElevatorAuto() {
	...
	protected void execute() {
		if (!Robot.elevatorLimitSwitchUp.get()) {
			...
			Robot.motorPWM_Elevator_Right.set(Config.ELEVATOR_MOTOR_SPEED_UP_AUTO);
			Robot.motorPWM_Elevator_Left.set(-Config.ELEVATOR_MOTOR_SPEED_UP_AUTO);
		}
	}
