 ...
 */
@SameLine
public class Left_ScaleIsLeft_FirstAngle extends PIDCommand {
	/**
	 ...
	 */
	public Left_ScaleIsLeft_FirstAngle(SpeedControllerGroup scgRight, SpeedControllerGroup scgLeft) {
