 ...
 */
@SameLine
public class Left_SwitchIsLeft_FirstAngle extends PIDCommand {
	/**
	 ...
	 */
	public Left_SwitchIsLeft_FirstAngle(SpeedControllerGroup scgRight, SpeedControllerGroup scgLeft) {
