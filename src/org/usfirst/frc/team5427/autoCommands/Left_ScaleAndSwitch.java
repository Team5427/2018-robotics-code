 ...
 * and places one cube on the left side of the scale and the switch.
 * 
...
public class Left_ScaleAndSwitch extends AutoPath {
	...
	/**
	 * The third distance of the path. It travels 70 inches forward at our long power.
	 */
	 ...
	 * Utilizes the default ending of AutoPath to shoot out any cubes in the robot.
	 */
	@Override
	protected void end() {
		super.end();
