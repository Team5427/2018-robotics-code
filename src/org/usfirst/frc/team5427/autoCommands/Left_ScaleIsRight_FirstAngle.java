 ...
 */
@SameLine
public class Left_ScaleIsRight_FirstAngle extends PIDCommand {
	/**
	 ...
	 */
	public Left_ScaleIsRight_FirstAngle(SpeedControllerGroup scgRight, SpeedControllerGroup scgLeft) {
