...
/**
 * This command turns the robot 80 degrees clockwise.
 * Used in the Left_SwitchIsRight command.
 * 
 * @author Andrew Li
 */
@SameLine
public class Left_SwitchIsRight_FirstAngle extends PIDCommand {
	/**
	 ...
	 */
	public Left_SwitchIsRight_FirstAngle(SpeedControllerGroup scgRight, SpeedControllerGroup scgLeft) {
