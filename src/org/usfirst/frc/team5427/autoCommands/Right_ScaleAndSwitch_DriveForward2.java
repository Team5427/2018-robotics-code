 ...
 * @author Andrew Li
 */
public class Right_ScaleAndSwitch_DriveForward2 extends Command {
	/**
	 * The time that the robot will drive forwards for.
	 */
	private double time = 0.7; // TODO change this value, untested
	 ...
	 */
	public Right_ScaleAndSwitch_DriveForward2() {
