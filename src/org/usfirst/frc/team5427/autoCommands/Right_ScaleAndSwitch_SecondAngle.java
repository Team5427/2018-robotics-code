 ...
 */
@SameLine
public class Right_ScaleAndSwitch_SecondAngle extends PIDCommand {
	/**
	 ...
	 */
	double setPoint = -90; // TODO change value, untested
	 ...
	 */
	public Right_ScaleAndSwitch_SecondAngle(SpeedControllerGroup scgRight, SpeedControllerGroup scgLeft) {
