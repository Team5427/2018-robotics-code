 ...
 * @author Akshat Jain
 */
public class Right_SwitchIsRight_SecondDistance extends PIDCommand {
	 ...
	 *            command.
	 */
	public Right_SwitchIsRight_SecondDistance(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
