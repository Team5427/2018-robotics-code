 ...
 * @author Akshat Jain
 */
public class Right_ScaleIsLeft_FirstDistance_Curve extends PIDCommand {
	 ...
	 *            command.
	 */
	public Right_ScaleIsLeft_FirstDistance_Curve(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
