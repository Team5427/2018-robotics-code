 ...
 * @author Andrew Li
 */
public class Right_ScaleIsLeft_ThirdDistanceEncoder extends Command {
	/**
	 ...
	 */
	public Right_ScaleIsLeft_ThirdDistanceEncoder(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
