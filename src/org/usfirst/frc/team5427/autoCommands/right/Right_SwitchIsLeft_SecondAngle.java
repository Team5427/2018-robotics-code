 ...
 */
@SameLine
public class Right_SwitchIsLeft_SecondAngle extends PIDCommand {
	/**
	 ...
	 */
	public Right_SwitchIsLeft_SecondAngle(SpeedControllerGroup scgRight, SpeedControllerGroup scgLeft) {
