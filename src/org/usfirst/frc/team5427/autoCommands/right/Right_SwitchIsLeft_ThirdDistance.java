...
/**
 * This command moves the robot forwards 70 inches.
 * Used in the Right_SwitchIsLeft command.
 * 
 * @author Andrew Li, Akshat Jain
 */
public class Right_SwitchIsLeft_ThirdDistance extends PIDCommand {
	 ...
	 *            command.
	 */
	public Right_SwitchIsLeft_ThirdDistance(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
