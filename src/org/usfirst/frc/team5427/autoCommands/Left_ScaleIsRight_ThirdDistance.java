 ...
 * @author Andrew Li
 */
public class Left_ScaleIsRight_ThirdDistance extends PIDCommand {
	 ...
	 *            command.
	 */
	public Left_ScaleIsRight_ThirdDistance(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
