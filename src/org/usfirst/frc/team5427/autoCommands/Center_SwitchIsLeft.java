 ...
 * and places one cube on the left side of the switch.
 * 
 * @author Blake
 */
@SameLine
public class Center_SwitchIsLeft extends AutoPath {
	...
	/**
	 * The first distance of the path. It travels forward 18 inches at our short power.
	 */
	private PIDStraightMovement firstDistance;
	
	/**
	 * The second distance of the path. It travels forward 110 inches at our long power.
	 */
	private PIDStraightMovement secondDistance;
	
	/**
	 * The third distance of the path. It travels forward 78 inches at .2 power higher than our long power.
	 */
	...
	/**
	 * Run once when the command is started. Starts the first portion of the
	 * path and sets the timeout of it.
	 */
