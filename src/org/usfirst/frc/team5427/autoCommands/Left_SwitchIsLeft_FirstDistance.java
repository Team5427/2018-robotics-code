 ...
 * @author Andrew Li
 */
public class Left_SwitchIsLeft_FirstDistance extends PIDCommand {
	 ...
	 *            command.
	 */
	public Left_SwitchIsLeft_FirstDistance(SpeedControllerGroup scgPIDControlled, SpeedControllerGroup scgConstant) {
